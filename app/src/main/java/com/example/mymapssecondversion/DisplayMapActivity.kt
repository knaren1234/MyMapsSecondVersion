...
import com.example.mymapssecondversion.databinding.ActivityDisplayMapBinding
...
class DisplayMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (userMap.places.size > 1) {
            ...
            mMap.moveCamera(CameraUpdateFactory.newLatLng(LatLng(userMap.places[0].latitude, userMap.places[0].longitude)))
        }
    }
}